...
contactsRouter.put("/:id", authenticate, emptyBody, validateBody(updateContactSchema), updateContact);

contactsRouter.patch(
  '/:id/favorite', authenticate, validateBody(updateFavoriteSchema), updateStatusContact);
